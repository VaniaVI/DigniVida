        ...
        <div className="container">
          <div className="dashboard-cards">
            <div className="dashboard-card">
              ...
              <p>
                Crea una nueva solicitud para que un voluntario te acompañe a
                realizar un trámite.
              </p>
              <Link to="/beneficiarioSolicitaAcompa" className="btn btn-primary">
                Solicitar
              </Link>
            </div>
            ...
            <div className="dashboard-card">
              <div className="card-icon">
                <img
                  src="https://cdn-icons-png.flaticon.com/128/10994/10994652.png"
                  alt="Icono historial"
                />
              </div>
              <h3>Mi Historial</h3>
              <p>
                Revisa el historial de tus solicitudes anteriores y los
                voluntarios que te han ayudado.
              </p>
              <Link to="/beneficiarioHistorial" className="btn btn-primary">
                Ver Historial
              </Link>
            </div>
            ...
            <div className="dashboard-card">
              ...
              <h3>Mi Perfil</h3>
              <p>
                Actualiza tu información personal, datos médicos y contactos de
                emergencia.
              </p>
              <Link to="/perfilBeneficiario" className="btn btn-primary">
                Editar Perfil
              </Link>
            </div>
          </div>
            ...
            <div className="request-card">
              <div className="request-status">
                ...
                <p className="status-text">
                  Tu voluntario llegará en aproximadamente 15 minutos
                </p>
              </div>
              ...
              <div className="volunteer-info">
                <div className="volunteer-details">
                  ...
                  <Link to="/beneficiarioSeguimiento" className="btn btn-secondary">
                    Ver Seguimiento
                  </Link>
                </div>
              </div>
